...
/*   Updated: 2025/05/27 15:43:48 by syl              ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	no_parsing(t_scene *scene)
{
	...
	//	scene->obj[1][0]->p_coord->x = 0.4;
	//scene->obj[1][0]->p_coord->y = 0.1;
	//scene->obj[1][0]->p_coord->z = 0.8;
...
/*	scene->obj[1][1]->p_coord->x = 0;
	scene->obj[1][1]->p_coord->y = 0;
	scene->obj[1][1]->p_coord->z = 0;
	scene->obj[1][1]->diam = 3;
	scene->obj[1][1]->color->r = 0.2;
	scene->obj[1][1]->color->g = 0.2;
	...
	scene->lux[1][0]->p_coord->x = 7;
	scene->lux[1][0]->p_coord->y = 5;
	scene->lux[1][0]->p_coord->z = 5;
}
