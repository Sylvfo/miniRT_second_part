...
/*   Updated: 2025/06/11 11:40:25 by syl              ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void apply_move_changes(t_scene *scene)
{
	...
	matrix_mult_2(scene->obj[obj_type][obj_num]->m_transf, scene->obj[obj_type][obj_num]->m_transl);
	re_identity_matrix(scene->obj[obj_type][obj_num]->m_inv);
	inverse_matrix_44(scene->obj[obj_type][obj_num]->m_inv, scene->obj[obj_type][obj_num]->m_transf);
...
void apply_rotate_changes(t_scene *scene)
{
	...
	matrix_mult_2(scene->obj[obj_type][obj_num]->m_transf, scene->obj[obj_type][obj_num]->m_rot);
	re_identity_matrix(scene->obj[obj_type][obj_num]->m_inv);
	inverse_matrix_44(scene->obj[obj_type][obj_num]->m_inv, scene->obj[obj_type][obj_num]->m_transf);
	printf("matrix inverse is done\n");
}
...
void apply_scale_changes(t_scene *scene)
{
	...
	matrix_mult_2(scene->obj[obj_type][obj_num]->m_transf, scene->obj[obj_type][obj_num]->m_scale);
	re_identity_matrix(scene->obj[obj_type][obj_num]->m_inv);
	inverse_matrix_44(scene->obj[obj_type][obj_num]->m_inv, scene->obj[obj_type][obj_num]->m_transf);
	printf("matrix inverse is done\n");
}
...
void apply_copy_changes(t_scene *scene)
{
	...
	//verifier si toujours place pour nouvel objet
	// nombre objet en plus
