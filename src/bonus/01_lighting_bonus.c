...
/*   Updated: 2025/10/09 14:29:46 by syl              ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	take_shadow_color(t_mem *mem_shuttle, t_intertt result, t_obj *obj)// amcien closestt
{
	...
	//	mem_shuttle->percent_shadow = 1.0 - (1.0 - mem_shuttle->percent_shadow) * (1.0 - obj->transparence);
		...
		*mem_shuttle->color_shadow = multipling_color(*mem_shuttle->color_shadow, *mem_shuttle->new_color_shadow);
		//*mem_shuttle->color_shadow = add_color(*mem_shuttle->new_color_shadow, *mem_shuttle->color_shadow);
